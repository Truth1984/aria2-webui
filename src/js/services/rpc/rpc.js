    ...
    function(syscall, globalTimeout, alerts, utils, rootScope, uri, authconf, filter) {
      ...
      var update = function() {
        ...
        var error = function() {
          ...
          if (configurations.length) {
            alerts.log(
              filter("translate")("The last connection attempt was unsuccessful. Trying another configuration")
            );
      ...
      return {
        ...
        configure: function(conf) {
          alerts.addAlert(
            filter("translate")("Trying to connect to aria2 using the new connection configuration"),
            "info"
          );
